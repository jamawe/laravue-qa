<template>
  <div class="bg-white h-12 px-4 flex items-center border-b border-gray-300 shadow-sm">
    ...
    <div class="w-1/3">
      ...
      <div class="flex items-center">
        ...
        <div class="ml-2 relative">
          ...
          <input type="text" name="search" class="w-56 pl-8 bg-gray-200 h-8 rounded-full focus:outline-none focus:shadow-outline text-sm" placeholder="Search...">
        </div>
      </div>
    ...
    <div class="w-1/3 flex justify-center items-center h-full">
      ...
      <router-link v-if="authUser" :to="'/users/' + authUser.data.user_id" class="px-6 h-full flex items-center">
